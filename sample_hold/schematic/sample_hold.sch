...
C {devices/lab_pin.sym} -110 240 0 0 {name=p20 sig_type=std_logic lab=CLKN}
C {devices/lab_pin.sym} 560 -90 1 0 {name=p21 sig_type=std_logic lab=CLKN}
C {devices/lab_pin.sym} 80 80 0 0 {name=p22 sig_type=std_logic lab=CLK}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 640 280 0 0 {name=C1 model=cap_mim_m3_1 W=10 L=10 MF=2 spiceprefix=X}
C {devices/lab_pin.sym} 640 310 3 0 {name=p23 sig_type=std_logic lab=VSS}
C {sky130_fd_pr/cap_mim_m3_1.sym} -70 30 0 0 {name=C2 model=cap_mim_m3_1 W=10 L=10 MF=2 spiceprefix=X}
C {devices/lab_pin.sym} 830 30 0 1 {name=p25 sig_type=std_logic lab=CLKN}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 810 80 0 0 {name=Ma2
L=0.5
W=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 810 -10 0 0 {name=Mb3
L=0.5
W=1
nf=1
mult=1
...
C {devices/lab_pin.sym} 830 -40 1 0 {name=p33 sig_type=std_logic lab=VCC}
C {devices/lab_pin.sym} 830 -10 2 0 {name=p34 sig_type=std_logic lab=VCC}
C {devices/lab_pin.sym} 830 80 2 0 {name=p35 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 790 30 0 0 {name=p36 sig_type=std_logic lab=CLK}
C {devices/lab_pin.sym} 830 110 3 0 {name=p32 sig_type=std_logic lab=VSS}
